...
// Используем классы для карточек, данные для них берем из db.json. 
// !!!Нужен сервак, чтоб всё робило
...
document.addEventListener("DOMContentLoaded", () => {
    // Переменная для запуска таймера на открытие модалки
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2020-12-20');
